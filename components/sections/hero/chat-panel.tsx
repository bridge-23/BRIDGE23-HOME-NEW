...
export function ChatPanel() {
  ...
  return (
    <Card className="p-4 md:p-6 h-full flex flex-col bg-white rounded-xl border-2 border-[rgba(182,182,209,0.15)]">
      ...
      <div className="mt-4 relative flex-shrink-0">
        <input
          ...
          className="w-full p-2 md:p-3 pr-10 md:pr-12 rounded-xl border-2 border-[rgba(182,182,209,0.15)] bg-white text-sm"
        />
