  ...
  return (
    <>
      <div className="bg-white rounded-lg border border-[rgba(182,182,209,0.15)] p-2 md:p-3">
        <p className="text-xs md:text-sm text-[#333333]">Which language can we use for canister?</p>
      </div>
      <div className="bg-[#F4F4F8] rounded-lg p-2 md:p-3">
        <div className="flex items-center gap-2 mb-1 md:mb-2">
          ...
          <p className="text-xs md:text-sm font-medium">Agent Centurio✨</p>
        </div>
        <p className="text-xs md:text-sm text-[#333333]">Seva suggest <span className="font-semibold">use RUST.</span></p>
      </div>
    </>
  )
}
    ...
    <>
      <div className="bg-white rounded-lg border border-[rgba(182,182,209,0.15)] p-2 md:p-3">
        <div className="flex items-center gap-2">
          ...
          <p className="text-xs md:text-sm font-medium"> Wira</p>
        </div>
      </div>
      <div className="bg-white rounded-lg border border-[rgba(182,182,209,0.15)] p-2 md:p-3">
        <div className="flex items-center gap-2">
          <div className="w-6 h-6 md:w-8 md:h-8 rounded-full bg-red-700 flex items-center justify-center text-white font-semibold text-xs md:text-sm">
          A
          </div>
            <p className="text-xs md:text-sm font-medium">Agent Centurio✨</p>
        </div>
